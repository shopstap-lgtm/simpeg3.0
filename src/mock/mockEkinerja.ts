...
export type EkinerjaStatus = 'NOT_SUBMITTED' | 'PENDING' | 'APPROVED' | 'REJECTED';

export interface EkinerjaReportItem {
  id: string;
  employeeId: string;
  employee: Employee;
  bulan: number;
...
export const mockEkinerjaList: EkinerjaReportItem[] = [
  {
    id: 'ek-001',
    employeeId: 'emp-002',
    employee: mockEmployees[1], // Hj. Siti Rohmah
    bulan: 7,
    tahun: 2026,
  ...
  },
  {
    id: 'ek-002',
    employeeId: 'emp-003',
    employee: mockEmployees[2], // Bambang Irawan
    bulan: 7,
    tahun: 2026,
  ...
  },
  {
    id: 'ek-003',
    employeeId: 'emp-004',
    employee: mockEmployees[3], // Nurul Hidayati
    bulan: 7,
    tahun: 2026,
  ...
  },
  {
    id: 'ek-004',
    employeeId: 'emp-005',
    employee: mockEmployees[4], // Rian Prasetyo
    bulan: 7,
    tahun: 2026,
  ...
  },
  {
    id: 'ek-005',
    employeeId: 'emp-008',
    employee: mockEmployees[7], // Dewi Lestari
    bulan: 7,
    tahun: 2026,
